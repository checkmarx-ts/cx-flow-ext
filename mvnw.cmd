...
mvn install:install-file -Dfile=cx-flow-%CX_FLOW_VERSION%.jar -DgroupId=com.checkmarx.flow -DartifactId=cx-flow -Dversion=%CX_FLOW_VERSION% -Dpackaging=jar -DgeneratePom=true
